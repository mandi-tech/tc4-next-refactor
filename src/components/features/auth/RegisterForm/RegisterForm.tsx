...
import { validarEmail, validarSenha, validarNomeCompleto } from "@/libs/utils/validadores";
...
export default function RegisterForm({ onSubmitOverride, isLoadingOverride }: RegisterFormProps) {
  ...
  return (
    <Form layout="vertical" className="w-full" onFinish={handleFinish} requiredMark={false}>
      {/* Nome Completo */}
      <Form.Item
        label="Nome completo"
        name="name"
      ...
      <Alert
        message={<span className="text-foreground text-sm font-bold">Requisitos da senha</span>}
        description={
          <ul className="pl-sm gap-xxs mt-xxs text-foreground-secondary flex list-disc flex-col text-xs">
