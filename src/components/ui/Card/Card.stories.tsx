...
import { WalletOutlined, ArrowUpOutlined, ArrowDownOutlined, CreditCardOutlined } from "@ant-design/icons";
...
const meta: Meta<typeof Card> = {
    ...
    decorators: [
        (Story) => (
        <div className="max-w-sm p-md bg-background text-foreground">
            <Story />
        </div>
        ),
    ],
