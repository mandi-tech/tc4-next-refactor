...
const meta: Meta<typeof Table> = {
    ...
    decorators: [
        (Story) => (
        <div className="w-full max-w-4xl p-lg bg-background text-foreground">
            <Story />
        </div>
        ),
    ],
...
const columnsMock: ColumnsType<TransactionData> = [
    ...
    },
    {
        ...
        <span className={record.type === "income" ? "text-success font-semibold" : "text-danger font-semibold"}>
